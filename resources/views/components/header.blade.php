...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right ">
        ...
        {{-- <li id="dropdownAkun" class="dropdown">
            <a href="#" id="akun" class="nav-link dropdown-toggle nav-link-lg nav-link-user" data-toggle="dropdown" aria-expanded="false">
